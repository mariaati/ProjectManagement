...
import { useCreateFacultyMutation } from "../redux/api/facultyAPI";

const CreateFaculty = () => {
  const { register, handleSubmit, formState: { errors }, reset } = useForm();
  const [createFaculty, { isLoading, isSuccess, error }] = useCreateFacultyMutation();
    ...
    <div className="container main-board">
      <div className="card shadow">
        <div className="card-header bg-white text-dark">
          <h4 className="m-2">Create Faculty</h4>
        </div>
        <div className="card-body">
          ...
          {isSuccess && <div className="alert alert-success mt-3">Faculty created successfully!</div>}
